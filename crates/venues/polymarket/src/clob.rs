...
pub fn build_v2_input(
    ...
    let shares_base = U256::from((size * 10f64.powi(DECIMALS as i32)) as u128);
    let usdc_base = U256::from((price * size * 10f64.powi(DECIMALS as i32)) as u128);
